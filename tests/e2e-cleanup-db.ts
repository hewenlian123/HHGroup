...
export const E2E_PRESERVED_CUSTOMER_ID = "33333333-3333-4333-8333-333333333333";
export const E2E_PRESERVED_ESTIMATE_ID = "44444444-4444-4444-4444-444444444449";
...
export async function cleanupTestData(supabase: SupabaseClient): Promise<CleanupTestDataResult> {
  ...
  await deleteByWorker("worker_reimbursements");
  await deleteByWorker("worker_advances");
  await deleteByWorker("worker_invoices");
