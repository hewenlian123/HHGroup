-- Recreate bank_transactions after the remote_schema snapshot dropped it.
-- Additive/idempotent: only touches public.bank_transactions and its policies/indexes.
