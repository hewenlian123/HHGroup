-- Run in Supabase Dashboard → SQL Editor if you get "Could not find table 'public.labor_entries'".
-- Creates workers, labor_entries (date, half_day_rate, indexes), labor_payments. Idempotent.
