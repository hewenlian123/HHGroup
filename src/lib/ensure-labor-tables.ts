...
const LABOR_DDL = [
  ...
  `CREATE POLICY worker_reimbursement_payments_insert_all ON public.worker_reimbursement_payments FOR INSERT TO anon WITH CHECK (true)`,
  `DROP POLICY IF EXISTS worker_reimbursement_payments_update_all ON public.worker_reimbursement_payments`,
  `CREATE POLICY worker_reimbursement_payments_update_all ON public.worker_reimbursement_payments FOR UPDATE TO anon USING (true) WITH CHECK (true)`,
  `DROP POLICY IF EXISTS worker_reimbursement_payments_delete_all ON public.worker_reimbursement_payments`,
  `CREATE POLICY worker_reimbursement_payments_delete_all ON public.worker_reimbursement_payments FOR DELETE TO anon USING (true)`,
