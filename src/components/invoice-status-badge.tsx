...
const invoiceStatusStyles: Record<InvoiceComputedStatus, string> = {
  ...
  Partial:
    "bg-amber-50 text-amber-700 border-amber-200/70 dark:bg-amber-950/30 dark:text-amber-300 dark:border-amber-800/70",
  Unpaid:
    "bg-zinc-100 text-zinc-700 border-zinc-200/70 dark:bg-zinc-800 dark:text-zinc-300 dark:border-zinc-700",
  Overdue:
    "bg-red-50 text-red-700 border-red-200/70 dark:bg-red-950/30 dark:text-red-300 dark:border-red-800/70",
  Draft:
    "bg-zinc-100 text-zinc-600 border-zinc-200/70 dark:bg-zinc-800 dark:text-zinc-400 dark:border-zinc-700",
...
export function InvoiceStatusBadge({
  ...
  const styles =
    ...
    "bg-zinc-100 text-zinc-700 border-zinc-200/70 dark:bg-zinc-800 dark:text-zinc-300";
  return (
    <span
      className={cn(
