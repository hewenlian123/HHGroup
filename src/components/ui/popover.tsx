  ...
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      className={cn(
        ...
        "z-50 w-auto overflow-visible rounded-md border border-[var(--hh-border-floating)] bg-[var(--hh-l4-floating-surface)] p-0 text-[var(--neo-text-primary)] shadow-[var(--hh-shadow-floating)] outline-none",
        motionPopoverLayer,
