...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-[var(--shadow-2)] transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out max-md:w-full max-md:max-w-none max-md:inset-0 max-md:rounded-none",
  {
    variants: {
      side: {
