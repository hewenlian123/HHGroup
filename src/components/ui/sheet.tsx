...
const sheetVariants = cva(
  "fixed z-50 gap-4 border-gray-300 bg-white p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out max-md:w-full max-md:max-w-none max-md:inset-0 max-md:rounded-none dark:border-border dark:bg-background dark:shadow-none",
  {
    variants: {
      side: {
