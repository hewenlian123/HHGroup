...
const LOGICAL_BREADCRUMB_RULES = [
  ...
  { prefix: "/labor/payroll-summary", labels: ["People", "Payroll Summary"] },
  { prefix: "/labor/payroll", labels: ["People", "Payroll Summary"] },
  { prefix: "/labor/payments", labels: ["People", "Worker Payments"] },
  { prefix: "/labor/advances", labels: ["People", "Worker Advances"] },
  { prefix: "/labor/reimbursements", labels: ["Financial", "AP", "Reimbursements"] },
  { prefix: "/labor/worker-balances", labels: ["People", "Worker Balances"] },
  { prefix: "/labor/worker-invoices", labels: ["People", "Worker Invoices"] },
