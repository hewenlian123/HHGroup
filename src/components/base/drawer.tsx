  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="right"
        className={cn(
          "flex h-full w-full max-w-md flex-col gap-0 border-l border-[var(--hh-border-strong)] bg-[var(--hh-l5-task-surface)] p-0 text-[var(--hh-text-primary)] shadow-task sm:max-w-md",
          className
        )}
      >
        {(title || description) && (
