...
export const billsGhostButtonClass =
  "h-9 rounded-[0.625rem] border-[var(--neo-border)] bg-[var(--neo-surface-raised)] text-[var(--neo-text-primary)] shadow-none hover:bg-[var(--neo-surface-muted)] focus-visible:ring-[var(--neo-gold-ring)]";

export const billsDestructiveGhostClass =
  "h-9 rounded-[0.625rem] border-[var(--neo-border)] bg-transparent text-rose-400/90 shadow-none hover:border-rose-500/30 hover:bg-rose-500/10 hover:text-rose-300";

export const billsFilterFieldClass = "h-10 rounded-[0.625rem] text-[13px] max-md:min-h-11";

export const billsDetailDlClass =
  "grid grid-cols-[minmax(0,9rem)_1fr] gap-x-4 gap-y-3 py-1 text-[13px] sm:grid-cols-[minmax(0,10rem)_1fr]";
