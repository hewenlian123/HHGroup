...
export function EstimateReadOnlyContent({ payload }: { payload: EstimateReadOnlyPayload }) {
  ...
  return (
    <>
      ...
      <div className="ml-auto max-w-md overflow-hidden rounded-sm border border-gray-100 p-6 dark:border-border">
        <div className="pb-2">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {rows.map((row) => (
                  <tr
                    key={row.id}
                    className="border-b border-gray-100/80 transition-colors hover:bg-[#F9FAFB] dark:border-border/30 dark:hover:bg-muted/20"
                  >
