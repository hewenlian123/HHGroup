...
function ClientEstimateField({
  ...
  return (
    <div className="flex min-w-0 items-center gap-2">
      <span className="shrink-0 text-xs uppercase whitespace-nowrap text-muted-foreground">
        {label}
      </span>
      <div
        className={cn(
  ...
  return (
    <article className="bg-white text-zinc-900 print:shadow-none">
      <div className="px-4 py-5 print:px-0 print:py-4">
        ...
        >
          <h2 className="text-[11px] font-semibold uppercase tracking-wide text-zinc-500 mb-6">
            Signature
          </h2>
