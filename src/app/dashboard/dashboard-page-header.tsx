  ...
  return (
    <>
      <header className="flex h-11 shrink-0 items-center md:hidden">
        <h1 className={cn(TYPO.pageTitle, "text-[20px] md:text-[20px]")}>Dashboard</h1>
      </header>
      <header className="hidden flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4 md:flex">
        <div className="min-w-0">
          <h1 className={TYPO.pageTitle}>Dashboard</h1>
          <p className={cn("mt-1", TYPO.pageSubtitle)}>Company overview</p>
        </div>
