  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          TYPO.date,
          "inline-flex h-11 min-h-[44px] shrink-0 items-center justify-center self-start rounded-full border border-[var(--hh-border)] bg-[var(--hh-l2-operational-surface)] px-4 text-[13px] font-medium tracking-normal text-[var(--hh-text-primary)] shadow-operational transition-[background,border-color,box-shadow] duration-150 hover:border-[var(--hh-border-strong)] hover:bg-[var(--hh-l3-hover)] max-md:w-full max-md:self-stretch md:h-9 md:w-auto md:min-h-0"
        )}
      >
        {chipDate}
      </span>
