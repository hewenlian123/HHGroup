...
import { type Account, type AccountType, type CashOverview } from "@/lib/data";
import {
  createAccountAction,
  deleteAccountAction,
  getAccountsAction,
...
function BankReconciliationOverview({ cashOverview, dataLoadWarnings }: AccountsClientProps) {
  const kpis = [
    ...
    { label: "Reconciled Total", value: cashOverview.reconciledBankTotal, icon: CheckCircle },
    { label: "Unreconciled Total", value: cashOverview.unreconciledBankTotal, icon: AlertCircle },
    { label: "Cash Difference", value: cashOverview.cashDifference, icon: Scale },
  ];
  ...
  return (
    <section className="border-b border-border/60 pb-4">
      ...
      <div className="mt-5">
        <h2 className={cn("mb-3", TYPO.sectionLabel)}>Recent Unreconciled Transactions</h2>
          ...
          <Table>
            ...
            <TableBody>
              {cashOverview.recentUnreconciled.length === 0 ? (
                ...
                cashOverview.recentUnreconciled.map((tx) => (
                  <TableRow key={tx.id}>
                    <TableCell>
...
export default function AccountsClient(props: AccountsClientProps) {
  return (
    <React.Suspense fallback={<div className="page-container py-6" />}>
      <AccountsPageInner {...props} />
    </React.Suspense>
  );
}
