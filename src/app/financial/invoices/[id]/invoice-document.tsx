...
function InvoiceDocumentA4Styles() {
  return (
    <style>{`
      .invoice-a4-page {
      ...
      .invoice-exporting-pdf .invoice-a4-page {
      ...
      @media print {
        ...
        .invoice-a4-page tr,
        .invoice-a4-page section,
        .invoice-a4-page footer {
          break-inside: avoid;
...
export function InvoiceDocument({ invoice, projectName, company }: InvoiceDocumentProps) {
  ...
  return (
    <>
      <InvoiceDocumentA4Styles />
      <article
        data-testid="invoice-preview-document"
        role="document"
        aria-label="Invoice document"
        className="invoice-a4-page financial-nums text-zinc-950 transition-colors duration-150 print:transition-none"
      >
        <header
