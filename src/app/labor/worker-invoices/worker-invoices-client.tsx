...
export type WorkerInvoicesPageCopy = {
  title: string;
  subtitle: string;
  searchPlaceholder: string;
  searchAriaLabel: string;
  newButtonLabel: string;
  newFabAriaLabel: string;
  totalLabel: string;
  openLabel: string;
  paidLabel: string;
  emptyTitle: string;
  ...
  actionsAriaPrefix: string;
};

const DEFAULT_COPY: WorkerInvoicesPageCopy = {
  title: "Worker Invoices",
  subtitle: "Track worker invoices, billed labor, payment status, and related projects.",
  searchPlaceholder: "Search workers, projects, invoices…",
  searchAriaLabel: "Search invoices",
  newButtonLabel: "New Invoice",
  newFabAriaLabel: "New invoice",
  totalLabel: "Total invoiced",
  openLabel: "Open invoices",
  paidLabel: "Paid invoices",
  emptyTitle: "No invoices yet",
  emptyDescription: "Create an invoice to track billed labor and payment status.",
  emptyButtonLabel: "Create first invoice",
  editTitle: "Edit Invoice",
  newTitle: "New Worker Invoice",
  fileLabel: "Invoice file (URL)",
  filePlaceholder: "Link to invoice file",
  fileActionLabel: "View invoice file",
  idColumnLabel: "Invoice #",
  actionsAriaPrefix: "Actions for invoice",
};

export function WorkerInvoicesClient({
  copy = DEFAULT_COPY,
}: {
  copy?: WorkerInvoicesPageCopy;
} = {}) {
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <div className="flex shrink-0 items-start gap-1">
                        ...
                        <RowActionsMenu
                          ariaLabel={`${copy.actionsAriaPrefix} ${invNo}`}
                          actions={actions}
                        />
                      </div>
                    </div>
            ...
            <table className="w-full min-w-[860px] border-collapse text-sm lg:min-w-0">
              <thead>
                <tr className="border-b border-zinc-100/90 bg-zinc-50/90 dark:border-border/60 dark:bg-muted/20">
                  ...
                  <th className={cn(thClass, "min-w-[120px]")}>{copy.idColumnLabel}</th>
