...
create policy workers_update_all on public.workers for update to authenticated using (true) with check (true);
...
create policy labor_entries_update_all on public.labor_entries for update to authenticated using (true) with check (true);
...
create policy labor_payments_update_all on public.labor_payments for update to authenticated using (true) with check (true);
drop policy if exists labor_payments_delete_all on public.labor_payments;
create policy labor_payments_delete_all on public.labor_payments for delete to authenticated using (true);
`;
